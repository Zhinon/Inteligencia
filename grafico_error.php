...
$datay1 = unserialize($_GET['e0']);
$datay2 = unserialize($_GET['e1']);
$datay3 = unserialize($_GET['e2']);
$datay4 = unserialize($_GET['e3']);
...
$p3->SetLegend('error fila 3');

// Create the cuarta line
$p4 = new LinePlot($datay4);
$graph->Add($p4);
$p4->SetColor("#5B1266");
$p4->mark->SetType(MARK_FILLEDCIRCLE,'',1.0);
$p4->mark->SetColor("#5B1266");
$p4->mark->SetFillColor("#5B1266");

$p4->SetLegend('error fila 4');
